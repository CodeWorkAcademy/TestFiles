...
public class MovieGenerator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int adjectiveIndexInput = rand.nextInt(adjectives.length-1);
        int nounIndexInput = rand.nextInt(nouns.length-1);

        String adjective = adjectives[adjectiveIndexInput];
        String noun = nouns[nounIndexInput];
        /* *************************************** */
